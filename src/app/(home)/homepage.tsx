...
export default function Herosection() {
  return (
    <main className=" bg-[url('/bgimg.png')] md:bg-[url('/bgmd.png')] bg-cover bg-center bg-no-repeat flex flex-col  items-center min-h-[85vh]  justify-between md:justify-center md:items-end md:px-20 py-8">
